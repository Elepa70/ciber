...
```
La transformación de un tipo rep a la especificación, es lo que se denomina **función de abstracción**. Por ejemplo, en el ejemplo anterior lo que hacemos es fijar quien es el dia, quien es el mes y quien es el año. 
...
- Sesgada: Escribimos el valor númerico pero susmandole el seco. El seco es un valor fijo con valor de $2^{n-1}$, siendo n un valor que ya hemos impuesto
